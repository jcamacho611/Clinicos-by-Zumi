...
| Public Home | `/` | Product pathways | Grid and EDU existed as substantial product paths but were easy to miss from the main site | WIRE | Add a persistent product pathway bar linking Clinic workspace, Grid, EDU, Capabilities, and Founding Clinics | Corrected |
