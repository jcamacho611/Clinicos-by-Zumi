...
**Required machine artifact:** `docs/governance/KLINIKOS_EXECUTION_TRACEABILITY.json`. The YAML migration source was retired by P00; JSON is the sole active machine ledger.
...
1. Maintain `docs/governance/KLINIKOS_EXECUTION_TRACEABILITY.json` as the sole canonical machine ledger; P00 retired the YAML migration source.
