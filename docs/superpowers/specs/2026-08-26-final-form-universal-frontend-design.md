...
This design is anchored to `main@fa3da16695aac0a60cf0c4b3fdab36c17b14a98a` on 2026-08-26. Executors MUST re-read current main before implementing any task and update the work ledger if main moves.
