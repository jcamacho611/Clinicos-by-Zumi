...
| `origin/fix/ecosystem-wiring-truth-2026-08-16` | `c427375` | `ACTIVE_RECOVERY` | Follow-up to PR #97: enforces the exact $500 checkout amount, bounds/caches public credential evidence, removes clearance-like UI, and neutralizes fixtures. |
