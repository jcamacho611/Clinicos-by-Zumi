 ...
 *
 * The governed patient rail can provide both the explicit tenant sender and its
 * Messaging Service so the sender remains deterministic while Messaging Service
 * behavior such as Advanced Opt-Out remains associated with the message.
 */
...
/** Start phone-possession verification. This is not messaging permission. */
