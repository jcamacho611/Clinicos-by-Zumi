    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          "Acceptance of these Terms permits only the protected access Klinikos actually grants. It does not create a professional license, clinical privilege, employment relationship, healthcare authorization, payment entitlement, marketplace eligibility, or authority to bind an organization.",
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          "Protected Klinikos environments may expose non-public information that is confidential, proprietary, commercially sensitive, pre-release, or eligible for trade-secret protection. This may include non-public software architecture, workflows, designs, specifications, data models, internal APIs, system prompts, model routing or orchestration methods, Grid matching or ranking methods, trust and anti-gaming methods, security design, internal telemetry, prototypes, roadmaps, pricing strategy, margins, unit economics, commission structures, implementation methods, customer or prospect information, and other non-public know-how.",
          ...
          "Information intentionally made public by Klinikos is not converted into a trade secret merely because these Terms exist. Contractual confidentiality supplements technical secrecy; it does not replace the need for Klinikos to keep its actual confidential machinery non-public.",
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Additional Grid participant, professional, organization, seller, transaction, or jurisdiction-specific terms may be required before regulated supply is published, sensitive information is disclosed, or a consequential transaction is completed.",
        ],
      },
      {
