...
export const legalDocumentRegistry: LegalDocumentDefinition[] = [
  ...
  { key: "grid_marketplace_terms", title: "Klinikos GRID Marketplace Terms", version: "2026-08-18.1", effectiveDate: "2026-08-18", route: "/legal/grid", mandatoryFor: ["provider", "location_partner", "clinic"], counselReviewRequired: true, productionApproved: false, notes: "Operative public marketplace terms are published; participant-specific provider, location, payment, employment/contractor, tax, consumer, and healthcare terms still require counsel review before broader transactional activation." },
