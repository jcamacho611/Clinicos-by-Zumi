...
export const legalDocumentRegistry: LegalDocumentDefinition[] = [
  { key: "website_terms", title: "Website Terms of Use", version: "2026-08-10.1", effectiveDate: "2026-08-10", route: "/legal/terms", mandatoryFor: ["public"], counselReviewRequired: true, productionApproved: false, notes: "Public-site terms. Final governing-law, liability and dispute language requires counsel." },
  ...
  { key: "acceptable_use", title: "Acceptable Use Policy", version: "2026-08-10.1", effectiveDate: "2026-08-10", route: "/legal/acceptable-use", mandatoryFor: ["clinic", "provider", "location_partner", "staff"], counselReviewRequired: true, productionApproved: false, notes: "Prohibits security abuse, unauthorized PHI use, unsupported clinical automation and illegal conduct." },
