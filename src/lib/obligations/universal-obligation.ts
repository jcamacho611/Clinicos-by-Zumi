...
export function projectTaskObligation(source: TaskObligationSource, now = new Date()): UniversalObligationProjection {
...
export function projectReferralObligation(source: ReferralObligationSource, now = new Date()): UniversalObligationProjection {
