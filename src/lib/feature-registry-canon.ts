export const REGISTRY_CANON_VERSION = "2026-07-14.1";
...
export const clinicOsDayOneRegistry: CanonicalRegistrySection[] = [
  ...
  section({
    ...
    databaseObjects: ["facilities", "providers", "network_connections", "data_sharing_agreements", "patient_identifiers", "patient_matches", "record_requests", "referrals", "integrations", "integration_events"], deliveryStatus: "PLANNED", deliveryMode: "adapter-ready",
  ...
  section({
    ...
    databaseObjects: ["form_templates", "form_submissions", "consents", "signatures", "documents"], deliveryStatus: "DEMO", deliveryMode: "native",
  ...
  section({
    ...
    ownerRoles: ["provider", "clinical_staff", "patient"], interfaceRoute: "/patients",
    databaseObjects: ["medications", "patient_pharmacies", "messages", "tasks", "prior_authorizations", "integrations"], deliveryStatus: "FOUNDATION", deliveryMode: "adapter-ready",
    features: "Medication list | Active medications | Historical medications | Dosage | Route | Frequency | Start and end dates | Prescribing provider | Medication reconciliation | Discontinued medication | Patient-reported medication | Refill requests | Refill-review queue | Pharmacy search | Preferred pharmacy | Allergy interaction alerts | Medication interaction roadmap | E-prescribing vendor integration | Controlled-substance and EPCS planning | PDMP integration planning | Prior authorization | Formulary checks | Human provider approval | Complete medication audit history",
  }),
  section({
  ...
  section({
    ...
    ownerRoles: ["provider", "clinical_staff", "patient", "pharmacy_partner"], interfaceRoute: "/pharmacy-network",
    databaseObjects: ["patient_pharmacies", "medications", "clinical_orders", "prior_authorizations", "messages", "integrations"], deliveryStatus: "VENDOR_DEPENDENT", deliveryMode: "adapter-ready",
