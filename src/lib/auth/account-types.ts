...
export function accountIdentityHasClinicContext(
  identity: MemberIdentity | ClinicAccountIdentity,
): identity is ClinicAccountIdentity {
  return "organizationId" in identity && "legacyUserId" in identity && "role" in identity;
}

export function accountSessionHasClinicContext(
  session: AccountSession,
): session is ClinicAccountSession {
