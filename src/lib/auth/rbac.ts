...
export type ClinicResource = "patients" | "appointments" | "encounters" | "billing" | "settings" | "users" | "registry" | "network" | "identity" | "consents" | "referrals" | "labs" | "imaging" | "medications" | "documents" | "forms" | "voice" | "tasks" | "escalations" | "messages" | "knowledge";
...
const permissions: Record<ClinicRole, Partial<Record<ClinicResource, ClinicAction[]>>> = {
  clinic_owner: {
    ...
    registry: ["read", "manage"], knowledge: ["read", "create", "update", "manage"], network: ["read", "create", "update", "manage"], identity: ["read", "create", "update", "manage"], consents: ["read", "create", "update", "manage"], referrals: ["read", "create", "update", "manage"], labs: ["read", "create", "update", "sign", "manage"], imaging: ["read", "create", "update", "sign", "manage"], medications: ["read", "create", "update", "sign", "manage"], documents: ["read", "create", "update", "sign", "manage"], forms: ["read", "create", "update", "sign", "manage"], voice: ["read", "create", "update", "manage"],
  },
  administrator: {
    ...
    registry: ["read"], knowledge: ["read", "create", "update", "manage"], network: ["read", "create", "update"], identity: ["read", "create", "update"], consents: ["read", "create", "update"], referrals: ["read", "create", "update"], labs: ["read", "create", "update"], imaging: ["read", "create", "update"], medications: ["read", "create", "update", "manage"], documents: ["read", "create", "update", "manage"], forms: ["read", "create", "update", "manage"], voice: ["read", "create", "update"], tasks: ["read", "create", "update"], escalations: ["read", "create", "update"], messages: ["read", "create", "update"],
  },
  provider: { patients: ["read", "update"], appointments: ["read", "update"], encounters: ["read", "create", "update", "sign"], billing: ["read"], registry: ["read"], knowledge: ["read", "create", "update"], network: ["read", "create"], identity: ["read", "update"], consents: ["read"], referrals: ["read", "create", "update"], labs: ["read", "create", "update", "sign"], imaging: ["read", "create", "update", "sign"], medications: ["read", "create", "update", "sign", "manage"], documents: ["read", "create", "update", "sign", "manage"], forms: ["read", "create", "update", "sign", "manage"], voice: ["read", "create", "update"], tasks: ["read", "create", "update"], escalations: ["read", "create", "update"], messages: ["read", "create", "update"] },
  clinical_staff: { patients: ["read", "update"], appointments: ["read", "update"], encounters: ["read", "create", "update"], registry: ["read"], knowledge: ["read"], network: ["read"], identity: ["read"], consents: ["read", "create"], referrals: ["read", "create", "update"], labs: ["read", "create", "update"], imaging: ["read", "create", "update"], medications: ["read", "create", "update"], documents: ["read", "create", "update"], forms: ["read", "create", "update"], voice: ["read", "create", "update"], tasks: ["read", "create", "update"], escalations: ["read", "create", "update"], messages: ["read", "create", "update"] },
  front_desk: { patients: ["read", "create", "update"], appointments: ["read", "create", "update"], encounters: ["read"], billing: ["read"], registry: ["read"], knowledge: ["read"], network: ["read"], identity: ["read", "create", "update"], consents: ["read", "create", "update"], referrals: ["read", "update"], labs: ["read", "create", "update"], imaging: ["read", "create", "update"], medications: ["read", "create", "update"], documents: ["read", "create", "update"], forms: ["read", "create", "update"], voice: ["read", "create", "update"], tasks: ["read", "create", "update"], escalations: ["read", "create", "update"], messages: ["read", "create", "update"] },
  biller: { patients: ["read"], appointments: ["read"], encounters: ["read"], billing: ["read", "create", "update"], registry: ["read"], knowledge: ["read"], network: ["read"], identity: ["read"], consents: ["read"], referrals: ["read"], labs: ["read"], imaging: ["read"], medications: ["read"], documents: ["read", "create", "update"], forms: ["read"], voice: ["read", "create"], tasks: ["read", "create", "update"], escalations: ["read"], messages: ["read", "create", "update"] },
  quality: { patients: ["read"], appointments: ["read"], encounters: ["read"], billing: ["read"], registry: ["read"], knowledge: ["read"], network: ["read"], identity: ["read"], consents: ["read"], referrals: ["read"], labs: ["read"], imaging: ["read"], medications: ["read"], documents: ["read"], forms: ["read"], voice: ["read", "create"], tasks: ["read", "create", "update"], escalations: ["read"], messages: ["read", "create", "update"] },
  case_manager: { patients: ["read", "update"], appointments: ["read"], encounters: ["read"], registry: ["read"], knowledge: ["read"], network: ["read", "create", "update"], identity: ["read", "update"], consents: ["read", "create", "update"], referrals: ["read", "create", "update"], labs: ["read", "create", "update"], imaging: ["read", "create", "update"], medications: ["read", "create", "update"], documents: ["read", "create", "update", "manage"], forms: ["read", "create", "update", "manage"], voice: ["read", "create", "update"], tasks: ["read", "create", "update"], escalations: ["read", "create", "update"], messages: ["read", "create", "update"] },
  viewer: { patients: ["read"], appointments: ["read"], encounters: ["read"], billing: ["read"], registry: ["read"], knowledge: ["read"], labs: ["read"], imaging: ["read"], medications: ["read"], documents: ["read"], forms: ["read"], tasks: ["read"], escalations: ["read"], messages: ["read"] },
};
