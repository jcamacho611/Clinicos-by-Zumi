...
export type ClinicResource = "patients" | "appointments" | "encounters" | "billing" | "settings" | "users" | "registry" | "network" | "identity" | "consents" | "referrals" | "labs" | "imaging" | "medications" | "documents" | "forms" | "voice" | "tasks" | "escalations" | "messages";
...
const permissions: Record<ClinicRole, Partial<Record<ClinicResource, ClinicAction[]>>> = {
  ...
  clinical_staff: { patients: ["read", "update"], appointments: ["read", "update"], encounters: ["read", "create", "update"], registry: ["read"], network: ["read"], identity: ["read"], consents: ["read", "create"], referrals: ["read", "create", "update"], labs: ["read", "create", "update"], imaging: ["read", "create", "update"], medications: ["read", "create", "update"], documents: ["read", "create", "update"], forms: ["read", "create", "update"], voice: ["read", "create", "update"], tasks: ["read", "create", "update"], escalations: ["read", "create", "update"], messages: ["read", "create", "update"] },
  ...
  biller: { patients: ["read"], appointments: ["read"], encounters: ["read"], billing: ["read", "create", "update"], registry: ["read"], network: ["read"], identity: ["read"], consents: ["read"], referrals: ["read"], labs: ["read"], imaging: ["read"], medications: ["read"], documents: ["read", "create", "update"], forms: ["read"], voice: ["read", "create"], tasks: ["read", "create", "update"], escalations: ["read"], messages: ["read", "create", "update"] },
  quality: { patients: ["read"], appointments: ["read"], encounters: ["read"], billing: ["read"], registry: ["read"], network: ["read"], identity: ["read"], consents: ["read"], referrals: ["read"], labs: ["read"], imaging: ["read"], medications: ["read"], documents: ["read"], forms: ["read"], voice: ["read", "create"], tasks: ["read", "create", "update"], escalations: ["read"], messages: ["read", "create", "update"] },
  ...
  viewer: { patients: ["read"], appointments: ["read"], encounters: ["read"], billing: ["read"], registry: ["read"], labs: ["read"], imaging: ["read"], medications: ["read"], documents: ["read"], forms: ["read"], tasks: ["read"], escalations: ["read"], messages: ["read"] },
};
