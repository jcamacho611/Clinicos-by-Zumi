...
export const clinicResources = [
  "patients", "appointments", "encounters", "billing", "coding", "luxe_medi", "sales", "company", "settings", "users", "registry", "network", "grid", "identity", "consents", "referrals", "labs", "imaging", "medications", "documents", "forms", "voice", "tasks", "escalations", "messages", "knowledge", "remote_monitoring", "inventory", "credentialing", "crm", "reliability", "care_teams", "cases", "quality", "insurance", "telemedicine", "portal", "integrations", "ai",
] as const;
...
const permissions: Record<ClinicRole, Partial<Record<ClinicResource, ClinicAction[]>>> = {
  clinic_owner: {
    ...
    registry: ["read", "manage"], knowledge: ["read", "create", "update", "manage"], remote_monitoring: ["read", "create", "update", "manage"], inventory: ["read", "create", "update", "manage"], credentialing: ["read", "create", "update", "manage"], crm: ["read", "create", "update", "manage"], sales: ["read", "create", "update", "manage"], company: ["read", "create", "update", "manage"], reliability: ["read", "create", "update", "manage"], network: ["read", "create", "update", "manage"], grid: ["read", "create", "update", "manage"], identity: ["read", "create", "update", "manage"], consents: ["read", "create", "update", "manage"], referrals: ["read", "create", "update", "manage"], labs: ["read", "create", "update", "sign", "manage"], imaging: ["read", "create", "update", "sign", "manage"], medications: ["read", "create", "update", "sign", "manage"], documents: ["read", "create", "update", "sign", "manage"], forms: ["read", "create", "update", "sign", "manage"], voice: ["read", "create", "update", "manage"], cases: ["read", "create", "update", "manage"], quality: ["read", "create", "update", "manage"], insurance: ["read", "create", "update", "manage"], telemedicine: ["read", "create", "update", "manage"], portal: ["read", "create", "update", "manage"], integrations: ["read", "create", "update", "manage"], ai: ["read", "create", "update", "manage"],
  },
  administrator: {
