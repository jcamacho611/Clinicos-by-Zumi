...
export type ClinicResource = "patients" | "appointments" | "encounters" | "billing" | "settings" | "users" | "registry" | "network" | "identity" | "consents" | "referrals" | "labs" | "imaging" | "medications" | "documents" | "forms" | "voice" | "tasks" | "escalations" | "messages" | "knowledge" | "remote_monitoring" | "inventory" | "credentialing" | "crm";
...
const permissions: Record<ClinicRole, Partial<Record<ClinicResource, ClinicAction[]>>> = {
  clinic_owner: {
    ...
    registry: ["read", "manage"], knowledge: ["read", "create", "update", "manage"], remote_monitoring: ["read", "create", "update", "manage"], inventory: ["read", "create", "update", "manage"], credentialing: ["read", "create", "update", "manage"], crm: ["read", "create", "update", "manage"], network: ["read", "create", "update", "manage"], identity: ["read", "create", "update", "manage"], consents: ["read", "create", "update", "manage"], referrals: ["read", "create", "update", "manage"], labs: ["read", "create", "update", "sign", "manage"], imaging: ["read", "create", "update", "sign", "manage"], medications: ["read", "create", "update", "sign", "manage"], documents: ["read", "create", "update", "sign", "manage"], forms: ["read", "create", "update", "sign", "manage"], voice: ["read", "create", "update", "manage"],
  },
  administrator: {
