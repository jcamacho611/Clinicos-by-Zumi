...
/**
 * Public surfaces explicitly governed by copy law. Keep this list broad. The
 * repository also carries a recursive page-source test so newly added public
 * pages cannot silently reintroduce legacy brand language.
 */
