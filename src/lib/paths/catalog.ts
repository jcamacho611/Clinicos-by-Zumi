...
export const klinikosPathCatalog: KlinikosPathDefinition[] = [
  ...
  },
  {
    ...
    nodes: [
      ...
      { id: "discover", label: "Review published availability", description: "Use Grid discovery and the map after reviewed, non-synthetic inventory is available.", href: "/grid/workspace", state: "upcoming" },
