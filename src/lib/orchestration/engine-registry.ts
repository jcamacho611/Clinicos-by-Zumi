...
export const klinikosEngineRegistry: readonly EngineRegistryEntry[] = [
  ...
  { number: 8, key: "path-persistence", name: "Path Persistence", status: "existing", authority: "KlinikosPathInstance + KlinikosPathEvent Prisma models", notes: "Durable actor/org-scoped Path state and append-only journey events are implemented; remaining work is broader domain adoption and recovery coverage." },
