        ...
        <div className="mx-auto max-w-5xl">
          ...
          <figure className="mt-10">
            <div
              ...
              /* Inert, not merely unclickable: the rows link into the authenticated app and
                 the claim/complete controls call APIs a signed-out visitor cannot use. The
                 figcaption below carries the same information in text, so nothing is lost
                 by keeping this out of the tab order. */
              inert
            >
