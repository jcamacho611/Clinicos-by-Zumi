...
import { gridCommercialModel } from "@/lib/commercial/klinikos-commercial";
...
export default function GridPricingPage() {
  return (
    <main className="min-h-screen bg-[#f7f8fa] text-[#0b1220]">
      ...
      <section className="border-b border-[#dfe3e8] bg-white"><div className="mx-auto max-w-[1400px] px-5 py-16 sm:px-8 lg:py-20"><p className="text-[12px] font-extrabold uppercase tracking-[.2em] text-[#174ea6]">Grid pricing</p><h1 className="mt-4 max-w-5xl text-5xl font-black leading-[.95] tracking-[-.06em] sm:text-6xl">Join easily. Pay for power and completed value.</h1><p className="mt-6 max-w-3xl text-sm leading-7 text-[#5b6675]">Grid keeps basic participation low-friction so the network can grow. Pro tools are optional. When a permitted transaction creates real value, Klinikos can earn through server-owned resource-class economics.</p></div></section>
