 ...
 *
 * Participation prices are current public offers. Transaction economics are different:
 * the declaration module may contain business proposals, but a public page must never
 * render a proposal as a live fee or describe it as legally cleared without review
 * evidence. Persisted server policy remains the settlement authority.
 */
    ...
    <main className="grid-marble-surface min-h-screen bg-[#f7f8fa] text-[#0b1220]">
      ...
      <section className="border-b border-[#dfe3e8] bg-white">
        <div className="mx-auto max-w-[1200px] px-5 py-16 sm:px-8">
          ...
          <p className="mt-5 max-w-2xl text-base leading-7 text-[#334155]">
            ...
            handled by resource class, and a proposed fee does not become a live charge until the required review
            and server-side policy gates are complete.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-[1200px] px-5 py-14 sm:px-8">
        ...
        <p className="mt-3 max-w-3xl text-[15px] leading-7 text-[#334155]">
          Healthcare marketplace economics can change with the thing being exchanged, the parties, the
          jurisdiction, payer rules and professional-practice restrictions. Fee-bearing proposals shown as
          drafts are not active charges. Patient-care and referral routing carry no Grid platform fee under the
          current policy.
        </p>
