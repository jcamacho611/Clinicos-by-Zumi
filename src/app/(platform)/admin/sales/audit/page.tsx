...
export default function SalesQualificationPage() {
  ...
  return <main className="min-h-screen bg-[#f6f5f1] text-[#171714] p-6 md:p-10"><div className="max-w-6xl mx-auto space-y-8">
    ...
    <section className="grid lg:grid-cols-[1.5fr_.8fr] gap-6"><div className="bg-white rounded-[28px] p-6 md:p-8 shadow-sm space-y-8">
      <div><p className="text-sm font-semibold">1 · Prospect identity</p><div className="grid md:grid-cols-3 gap-4 mt-4"><Field label="Clinic" value={form.clinic} onChange={v=>set("clinic",v)}/><Field label="Decision maker" value={form.decisionMaker} onChange={v=>set("decisionMaker",v)}/><Field label="Buyer email" value={form.email} onChange={v=>set("email",v)}/></div></div>
