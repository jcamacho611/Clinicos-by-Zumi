...
export default function NdaGeneratorClient() {
  ...
  const result = useMemo(() => buildNdaPackage({ recipientName, recipientEntity, recipientState, relationshipType, permittedPurpose, disclosureLevel }), [recipientName, recipientEntity, recipientState, relationshipType, permittedPurpose, disclosureLevel]);
