...
export const metadata: Metadata = {
  ...
  description: "Manage Klinikos Grid needs, offers, reservations, fulfillment, and financial obligations from one role-aware command surface.",
};
...
export default async function GridTransactionsPage() {
  ...
  return <main className="mx-auto w-full max-w-[1600px] px-4 py-5 sm:px-6 lg:px-8">
    ...
    <div className="mt-5 rounded-[1.35rem] border border-amber-200/10 bg-amber-200/[.045] px-4 py-3 text-[10px] leading-5 text-amber-100/70"><ShieldCheck className="mr-2 inline size-4" /><strong className="font-extrabold text-amber-100">Current boundary:</strong> this surface remains synthetic/demo gated. Manual GoDaddy payment evidence is not processor verification, and financial obligations are not automated payouts.</div>
