    ...
    <SalesSiteShell>
      <section className="mx-auto max-w-[1500px] px-5 pb-24 pt-20 sm:px-8 lg:px-12 lg:pt-28">
        ...
        <CinematicReveal className="mt-20 overflow-hidden rounded-[34px] border border-cyan-300/15 bg-[linear-gradient(120deg,rgba(34,211,238,.08),rgba(255,255,255,.025),rgba(16,185,129,.06))] p-7 sm:p-10 lg:p-12" delay={0.13}>
          <div className="grid gap-8 lg:grid-cols-[.75fr_1.25fr] lg:items-end"><div><p className="text-[10px] font-black uppercase tracking-[.2em] text-cyan-300">Klinikos Grid</p><h2 className="mt-4 text-4xl font-black tracking-[-.055em]">Need something? Have something? Start there.</h2></div><p className="max-w-2xl text-sm leading-7 text-slate-300">Grid is the network layer for work, providers, locations, services, and capacity. Browse available supply or join the network and tell Klinikos what you can offer.</p></div>
