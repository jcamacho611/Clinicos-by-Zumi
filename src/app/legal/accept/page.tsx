  ...
  return (
    <main className="grid min-h-screen place-items-center bg-[#050303] px-5 py-10 text-[#f8efed]" data-klinikos-ds>
      <section className="w-full max-w-2xl rounded-[30px] border border-[#e6817b]/15 bg-[#0b0507] p-7 sm:p-10">
        ...
        <p className="mt-7 text-[10px] font-extrabold uppercase tracking-[.22em] text-[#e6817b]">Protected access paused</p>
    ...
    return (
      <main className="grid min-h-screen place-items-center bg-[#050303] px-5 py-10 text-[#f8efed]" data-klinikos-ds>
        <section className="w-full max-w-2xl rounded-[30px] border border-[#e6817b]/15 bg-[#0b0507] p-7 sm:p-10">
          ...
          <p className="mt-7 text-[10px] font-extrabold uppercase tracking-[.22em] text-[#e6817b]">Agreement evidence unavailable</p>
