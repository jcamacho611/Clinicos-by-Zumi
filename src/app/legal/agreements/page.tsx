    ...
    <main className="min-h-screen bg-[#050303] px-5 py-10 text-[#f8efed] sm:px-8 sm:py-14" data-klinikos-ds>
      <div className="mx-auto max-w-5xl">
        <div className="flex flex-col gap-5 border-b border-[#e6817b]/10 pb-7 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <p className="text-[10px] font-extrabold uppercase tracking-[.22em] text-[#e6817b]">Agreements</p>
              ...
              <article className="rounded-[24px] border border-[#e6817b]/12 bg-[#0b0507] p-5 sm:p-6" key={agreement.id}>
                <div className="flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between">
                  <div className="min-w-0">
                    ...
                    <p className="mt-3 break-all font-mono text-[10px] leading-5 text-[#725d59]">SHA-256 {agreement.documentSha256 || "Legacy acceptance did not preserve a document hash."}</p>
                    <p className="mt-2 text-[10px] uppercase tracking-[.14em] text-[#806965]">Status: {agreement.status}</p>
                  </div>
