...
export const zumiToolCatalog = [
  ...
  { key: "quality_guardian", family: "assurance", label: "Quality Guardian", description: "Evaluate already-authorized versioned rule/evidence results, surface quality gaps and review-required work, and prepare internal-first or Expert Grid next actions without allowing AI to establish compliance truth.", actions: ["read", "compute", "draft"], risk: "HIGH", sendsDataExternally: false, implementation: "available_to_wire" },
