...
async function invokeCloudflare(
  ...
  return {
    ...
    inputTokens,
    outputTokens,
    // Conservative marginal cost from explicitly configured current model rates.
    // Account-wide free allocations, credits, or negotiated discounts are deliberately
    // not assigned to a request unless the billing system can attribute them truthfully.
    // This keeps deep-cognition budgets and customer-funded usage from treating paid
    // inference as free.
