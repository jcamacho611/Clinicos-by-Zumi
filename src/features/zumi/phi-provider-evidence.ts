...
/**
 * Evaluate whether one exact model-provider deployment has sufficient corroborating
 * evidence for a future PHI-capable inference path.
 *
 * This does not inspect prompts, patients, consent, tenant entitlement, clinical
 * authority, or disclosure scope. It answers only whether the exact runtime provider
 * identity has current evidence and the independent runtime gates still agree.
 */
