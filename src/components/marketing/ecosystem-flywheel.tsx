...
const entries: Entry[] = [
  ...
  { key: "care", label: "I’m looking for care", statement: "Describe the need → find the appropriate entry → continue in a patient-safe experience.", description: "Patients should not have to understand seller mechanics. Klinikos guides administrative discovery without diagnosing, overriding clinical triage, or guaranteeing availability.", stages: ["network", "capacity", "grid"], action: { label: "Start from the patient portal", href: "/portal" }, icon: HeartHandshake },
];
