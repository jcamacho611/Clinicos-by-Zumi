    ...
    <section className="relative overflow-hidden border-t border-[#e6817b]/10 bg-[#080304] text-[#f8efed]">
      ...
      <div className="relative mx-auto max-w-[1500px] px-5 py-16 sm:px-8 lg:py-24">
        <div className="grid gap-8 lg:grid-cols-[.8fr_1.2fr] lg:items-end">
          <div><p className="text-[10px] font-extrabold uppercase tracking-[.23em] text-[#efaaa1]">One ecosystem, different entry points</p><h2 className="mt-4 text-4xl font-light leading-tight tracking-[-.055em] sm:text-6xl">You should not have to understand Klinikos before Klinikos can route you to the right next step.</h2></div>
