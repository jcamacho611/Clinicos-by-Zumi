  ...
  return <aside aria-label="Klinikos Grid public entry" className="pointer-events-none fixed inset-x-0 bottom-3 z-[70] px-3 sm:inset-x-auto sm:bottom-5 sm:right-5 sm:w-[390px] sm:px-0">
    <div className="pointer-events-auto overflow-hidden rounded-[1.4rem] border border-cyan-200/20 bg-[#050b13]/95 shadow-[0_24px_80px_rgba(1,8,18,.62)] backdrop-blur-xl">
      <div className="relative overflow-hidden border-b border-white/10 px-4 py-3.5 sm:px-5 sm:py-4">
        ...
        <div className="relative flex items-center gap-3">
          ...
          <div className="min-w-0 flex-1">
            <div className="flex items-center gap-2"><p className="text-[9px] font-black uppercase tracking-[.2em] text-cyan-200">Klinikos Grid</p><span className="rounded-full border border-emerald-300/15 bg-emerald-300/10 px-1.5 py-0.5 text-[8px] font-extrabold uppercase tracking-[.1em] text-emerald-200">Live entry</span></div>
      ...
      <div className="hidden sm:block">
        ...
        <div className="flex items-center justify-between gap-3 bg-[#050b13] px-4 py-2.5 text-[8px] uppercase tracking-[.13em] text-white/30"><span className="inline-flex items-center gap-1.5"><Sparkles className="size-3 text-amber-200/70" />Grid sorts eligibility + fit</span><Link className="font-extrabold text-cyan-200/70 hover:text-cyan-100" href="/grid/pricing">Pricing</Link></div>
      </div>
