...
const STORAGE_KEY = "klinikos-atmosphere";
...
export function KlinikosAtmosphereController() {
  ...
  useEffect(() => {
    ...
    const refresh = () => setAtmosphere(applyAtmosphere(nextPreference));
