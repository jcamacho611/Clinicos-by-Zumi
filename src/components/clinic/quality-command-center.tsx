  ...
  return <div className="mx-auto w-full max-w-[1500px] space-y-6 px-4 py-6 md:px-6 lg:px-8">
    ...
    <section className="rounded-[24px] border border-white/8 bg-white/[.02] p-4 md:p-5">
      <div className="flex flex-col gap-2 border-b border-white/8 pb-4 md:flex-row md:items-center md:justify-between">
        ...
        <span className="w-fit rounded-full border border-white/10 px-3 py-1.5 text-[10px] font-bold uppercase tracking-[.12em] text-[#bca5a1]">
        ...
        {workspace.gaps.map((gap) => <li className="grid gap-4 py-5 lg:grid-cols-[minmax(0,1.5fr)_minmax(160px,.7fr)_minmax(180px,.8fr)_auto] lg:items-center" key={gap.id}>
          <div className="min-w-0">
            <div className="flex flex-wrap items-center gap-2">
              <span className="rounded-full border border-white/10 px-2.5 py-1 text-[10px] font-bold uppercase tracking-[.1em] text-[#c7b1ad]">{timingLabel(gap.timing)}</span>
              <span className="rounded-full border border-white/10 px-2.5 py-1 text-[10px] font-bold uppercase tracking-[.1em] text-[#c7b1ad]">{gap.impact} impact</span>
              {gap.requiresReview && <span className="rounded-full border border-[#d98f93]/20 bg-[#d98f93]/[.06] px-2.5 py-1 text-[10px] font-bold uppercase tracking-[.1em] text-[#e9aaa8]">Human review</span>}
            </div>
          ...
          <div>
            <p className="text-[10px] font-bold uppercase tracking-[.12em] text-[#806d69]">Due</p>
          ...
          <div>
            <p className="text-[10px] font-bold uppercase tracking-[.12em] text-[#806d69]">Operational work</p>
