...
export async function NetworkDirectoryRoute({ admin = false, initialTargetOrganizationId = "" }: { admin?: boolean; initialTargetOrganizationId?: string }) {
