...
const gridTools: readonly LaunchItem[] = [
  ...
  { href: "/grid/resources/browse", label: "Browse resources", description: "Explore the universal resource marketplace and available capacity." },
  { href: "/grid/resources", label: "My Grid resources", description: "Create and manage the resources or capacity your organization can offer." },
  { href: "/grid/resources/offers", label: "Resource deals", description: "Review offers, terms, reservations, and eligible resource deals." },
          ...
          <div key={group.label}>
            ...
            <div className="divide-y divide-[#0b1e3a]/8">
              {group.items.map((item) => (
                <Link className="group flex items-start gap-4 py-4" href={item.href} key={item.href}>
