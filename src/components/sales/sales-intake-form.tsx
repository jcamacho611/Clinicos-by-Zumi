  ...
  if (submission) {
    return (
      <section aria-live="polite" className="relative overflow-hidden rounded-[32px] border border-[#e6817b]/20 bg-[linear-gradient(145deg,rgba(230,129,123,.1),rgba(255,255,255,.035))] p-7 shadow-[0_40px_120px_rgba(0,0,0,.4)] sm:p-10">
        ...
        <p className="mt-7 text-[10px] font-black uppercase tracking-[.2em] text-[#efaaa1]">Request saved</p>
        ...
        <div className="mt-8 grid gap-3 sm:grid-cols-3">
          ...
          <div className="rounded-2xl border border-white/10 bg-black/20 p-4"><p className="text-[9px] font-black uppercase tracking-[.14em] text-slate-500">Selected</p><p className="mt-2 text-xs font-bold text-white">{analysisOffer.name}</p><p className="mt-1 text-[10px] text-slate-500">{analysisOffer.priceLabel}</p></div>
          <div className="rounded-2xl border border-white/10 bg-black/20 p-4"><p className="text-[9px] font-black uppercase tracking-[.14em] text-slate-500">Payment</p><p className={`mt-2 text-xs font-bold ${submission.checkoutUrl ? "text-[#efaaa1]" : "text-amber-200"}`}>{submission.checkoutUrl ? "Secure checkout ready" : "Saved for follow-up"}</p></div>
        </div>
    ...
    <form className="grid gap-6 xl:grid-cols-[1.08fr_.92fr]" onSubmit={submit}>
      <div className="overflow-hidden rounded-[32px] border border-white/10 bg-[#0a0e14]/90 shadow-[0_40px_120px_rgba(0,0,0,.42)]">
        <div className="border-b border-white/[.08] px-6 py-6 sm:px-8">
          <div className="flex flex-wrap items-center justify-between gap-3"><div><p className="text-[10px] font-black uppercase tracking-[.2em] text-[#efaaa1]">Clinic analysis intake</p><h2 className="mt-2 text-2xl font-black tracking-[-.04em]">Save the clinic once, then continue to the exact checkout.</h2></div><StatusPill status="Live" /></div>
        </div>
        ...
        <div className="space-y-9 p-6 sm:p-8">
          ...
          <section>
            <p className="mb-4 text-[10px] font-black uppercase tracking-[.18em] text-slate-500">04 / Paid engagement</p>
            <div className="rounded-2xl border border-[#e6817b]/28 bg-[#e6817b]/[.07] p-5">
              ...
              <p className="mt-4 border-t border-white/10 pt-4 text-[10px] leading-5 text-slate-500">{analysisOffer.creditForward}</p>
            </div>
            <p className="mt-3 text-[10px] leading-5 text-slate-600">Implementation Blueprint, Founding Clinic Implementation, and recurring software are reviewed after this analysis. They are not selectable from this checkout intake.</p>
          </section>
          ...
          <p className="text-center text-[10px] leading-5 text-slate-600">The reservation is saved before payment. Klinikos then creates the exact server-owned checkout intent; browser return is never payment proof.</p>
        </div>
      </div>
      ...
      <aside className="xl:sticky xl:top-6 xl:self-start">
        <div className="overflow-hidden rounded-[32px] border border-white/10 bg-[linear-gradient(155deg,rgba(15,23,42,.94),rgba(6,10,15,.98))] shadow-[0_40px_120px_rgba(0,0,0,.45)]">
          <div className="border-b border-white/[.08] p-6 sm:p-8">
            ...
            <p className="mt-7 text-[10px] font-black uppercase tracking-[.2em] text-[#efaaa1]">Synthetic scenario preview</p>
