    ...
    <li className="relative">
      <article className={`${marketplaceSurfaces.cardInteractive} h-full rounded-[18px] p-5`}>
        ...
        <div className="mt-4 flex items-end justify-between gap-4 border-t border-[#e8ded9] pt-4">
          <span className="text-[11px] font-extrabold uppercase tracking-[.13em] text-[#756461]">Terms / rate</span>
          ...
          <div className="flex flex-wrap items-center gap-3">
            <div className="relative min-w-0 flex-1">
              ...
              <input
                ...
                className="h-11 w-full rounded-full border border-[#e8ded9] bg-[#fffdf9] pl-10 pr-3 text-sm text-[#241517] placeholder:text-[#756461] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#a8474e]"
