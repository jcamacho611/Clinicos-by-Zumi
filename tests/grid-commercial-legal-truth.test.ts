...
describe("Grid commercial legal truth", () => {
  ...
  it("keeps explicit patient-care and referral no-fee policy at zero", () => {
  ...
  it("does not let unapproved Grid marketplace terms coexist with evidence-free active fee declarations", () => {
