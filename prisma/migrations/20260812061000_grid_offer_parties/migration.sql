...
FOREIGN KEY ("senderOrganizationId") REFERENCES "organizations"("id") ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE "GridOfferRecord"
ADD CONSTRAINT "GridOfferRecord_recipientOrganizationId_fkey"
FOREIGN KEY ("recipientOrganizationId") REFERENCES "organizations"("id") ON DELETE SET NULL ON UPDATE CASCADE;
