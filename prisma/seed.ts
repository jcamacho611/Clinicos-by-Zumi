...
async function main() {
  ...
  await prisma.gridPayout.deleteMany();
  ...
  await prisma.gridRequest.create({
    data: {
      ...
      locationType: "mobile",
      safetyFlags: ["Human review required", "Licensed medical review required"],
      requiredDocuments: ["Synthetic clinic scope summary", "Synthetic location checklist"],
      requiredConsent: true,
      consentStatus: "pending",
      depositStatus: "not_required",
      paymentStatus: "not_started",
  ...
  await prisma.gridPayout.create({
    data: {
      ...
      status: "estimated",
      notes: "Synthetic estimate only. Manual administrator approval is required; no payout is guaranteed or automated.",
    },
  });
